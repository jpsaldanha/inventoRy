...
The  inventoRy package offers  nonparametric bootstrap and conventional parametric approaches for estimating inventory policy decisions such as the reorder point (ROP) and safety stocks (SS). These functions are for single item inventories under the continuous review inventory policy using either the cycle service level (CSL) or fill rate (FR) targets. 
